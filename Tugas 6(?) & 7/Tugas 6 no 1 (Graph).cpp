...
// Fungsi untuk mencari jalur terpendek dan minimum cost menggunakan algoritma Brute Force
void findShortestPath(const vector<vector<int>>& costMatrix, int startCity, int numCities) {
    vector<int> cities;
    vector<int> path;
    int minCost = INT_MAX;
    ...
    do {
        ...
        // Memeriksa jika cost jalur saat ini lebih kecil dari minimum cost sebelumnya
